...
const Page = () => {
  ...
  return (
    <>
      ...
      <div className=" flex flex-row md:flex-row  gap-40 p-14 mb-5 bg-white">
        {/* Left Info */}
        <div className="flex flex-col w-[478px] h-[468px] gap-10 mt-15 ml-10">
          <h1 className="w-[478px] h-[478px] museo font-black text-[40px]">
            Get In Touch
          </h1>
          <p className="w-[478px] h-15 text-base museo font-medium">
