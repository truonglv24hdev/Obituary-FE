  ...
  const handleSearchMemorial = debounce(
    (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      if (value === "") {
        ...
        router.push(`${pathname}?${createQueryString("memorial", value)}`);
      }
    },
    500
  );
            ...
            {activeTab === "users" && (
              <>
                <div className="w-full sm:w-80 items-center h-16 sm:h-20 border bg-white rounded-lg p-3 sm:p-4 flex justify-between">
                  <div className="text-lg sm:text-2xl museo font-medium">
                    Total Users
                  </div>
          ...
          >
            ...
            <TabsList className="w-full sm:w-130 h-11 grid grid-cols-2 sm:flex">
              ...
              >
                ...
                <span className="text-base sm:text-xl ml-1 sm:ml-0">
                  Memorials
                </span>
              </TabsTrigger>
            </TabsList>
              ...
              <Card className="p-2 sm:p-4">
                <CardHeader className="px-2 sm:px-6">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <CardTitle className="text-2xl sm:text-4xl museo">
                      User Management
                    </CardTitle>
