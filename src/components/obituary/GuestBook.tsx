    ...
    <div className="flex flex-col gap-10 mt-16">
      <div className="flex flex-col  justify-between">
        ...
        <div className="flex justify-end gap-3">
          <Button type="button" className="w-[123px] h-10 flex text-sm museo justify-between gap-2 px-4 py-2 rounded bg-white border border-[#699D99] shadow text-[#699D99] hover:bg-gray-50">
