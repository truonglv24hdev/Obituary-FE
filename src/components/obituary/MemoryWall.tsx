...
function UploadPhotoModal({ open, onClose, onConfirm }) {
  if (!open) return null;
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
      <div className="w-[420px] h-[340px] rounded-2xl p-8 bg-white shadow-xl relative flex flex-col">
        <button
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full h-[160px] border-2 border-dashed border-[#00000040] rounded bg-[#f5fbf8] flex flex-col items-center justify-center">
